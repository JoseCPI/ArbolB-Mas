/*
*Hecho por Sebastian Rodriguez, Fabian Encinas y Jose Pimienta
*Enero 2018
*
*/
#include <cstdlib>
    ...
    do
    {
        ...
        switch(option)
        {
            ...
            case 2:
                ...
                cin>>value;
                if(bp.searchValue(value)) cout << "El elemento "<<value<<" fue encontrado." << endl;
                else cout << "El elemento "<<value<<" no fue encontrado." << endl;
                system("pause");;
                break;
